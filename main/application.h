...
#define MAIN_EVENT_CAPTION_PROGRESS (1 << 14)
...
private:
    ...
    // Network receive and output tasks share only these small timing snapshots.
    std::mutex caption_mutex_;
    uint32_t caption_sequence_ = 0;
    uint32_t receiving_caption_id_ = 0;
    uint32_t receiving_caption_ms_ = 0;
    uint32_t playing_caption_id_ = 0;
    uint32_t playing_caption_ms_ = 0;
#endif
